...
<div class="j-header">
  <div class="name">
    <h1>International Journal on Computer Vision, Machine Learning, and Data Mining (CVMLDM)<!-- <br><p class="body">ISSN: 1929-2732</p> --></h1>
    <div class="oalink">
