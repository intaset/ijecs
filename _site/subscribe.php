...
<script>
  (function() {
    var cx = '016656741306535874023:qjzglezysvk';
...
<div class="j-header">
  <div class="name">
    <h1>International Journal of Electrical and Computer Systems (IJECS)<br><p class="body">ISSN: 1929-2716</p></h1>
    <div class="oalink">
    ...
    <img src="../img/journals/j-ijecs.jpg" class="j-img">
</div>
</div>

<div class="desktop jhead">
  <div class="name">
    <h1>International Journal of Electrical and Computer Systems (IJECS)</h1>
    <div class="issn">
    <p class="body">ISSN: 1929-2716</p>
    <div class="oalink">
    <a href="http://avestia.com/openaccess" target="blank" title="Avestia's Open Access">
          <img src="../img/j-oa.png" border="0" onmouseover="this.src='../img/j-oa-hover.png'" onmouseout="this.src='../img/j-oa.png'" class="j-oa">
    </a>
...
$confirmed = 0;
 ...
 // now we insert it into the database
  ...
  $subject = "International Journal of Electrical and Computer Systems (IJECS)"; 
  $message = "Thank you for signing up to receive alerts for IJECS - International Journal of Electrical and Computer Systems.
...
<div class="desktop jhead">
  ...
  <div class="main-content j-home">
    ...
    <p class="body">Thank you for subscribing to IJECS - International Journal of Electrical and Computer Systems. A confirmation email has been sent to your email. Please click on the confirmation link available in the email to confirm your subscription.</p>
